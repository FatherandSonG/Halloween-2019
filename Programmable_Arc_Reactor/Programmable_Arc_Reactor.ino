...
// Modified October 2019 by Robin Gambin
#include <Adafruit_NeoPixel.h>
#define N_LEDS 24 //need to define which pin the neopixel data line is connected to
#define DATA_PIN 2  //Data out to NeoPixels
#define BTN_PIN 4  //Button input
#define BTN_DELAY 250  //To help reduce button bounce
